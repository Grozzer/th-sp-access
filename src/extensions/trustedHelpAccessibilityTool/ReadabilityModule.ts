// interface IReadabilityModule {
// 	calculateScore(text: string): string;
// 	calculateScoreForPage(): string;
// }

// class SharePointReadabilityModule implements IReadabilityModule {
// 	calculateScore(text: string): string {
...
// 	private sentenceRegex: RegExp = new RegExp('[.?!]\\s[^a-z]', 'g');
// 	private syllableRegex: RegExp = new RegExp('[aiouy]+e*|e(?!d$|ly).|[td]ed|le$', 'g');

// 	public calculate(text) {
